...
# Load the statistics
with open('../model/conv1d-lstm/statistics.pkl', 'rb') as f:
...
converter = tf.lite.TFLiteConverter.from_saved_model('../model/conv1d-lstm/trained_conv1d-lstm_model') # path to the SavedModel directory
