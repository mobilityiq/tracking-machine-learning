...
model = Models.create_lstm_model(num_classes=num_classes, input_shape=(X_train.shape[1], 1))
...
# Save statistics
with open('../model/lstm/statistics.pkl', 'wb') as f:
...
with open('../model/lstm/metadata.json', 'w') as f:
    f.write(metadata_json)

statistics_json = json.dumps(train_statistics)

with open('../model/lstm/statistics.json', 'w') as f:
...
coreml_model.save('../model/lstm/lstm.mlmodel')

# ** Evaluate on the test set **
print("*** Evaluating model ***")
# Load the labels
loaded_classes = np.load('../model/lstm/label_encoder.npy')
label_encoder = LabelEncoder()
label_encoder.classes_ = loaded_classes
# Load the statistics
with open('../model/lstm/statistics.pkl', 'rb') as f:
...
with open('/Users/josecatala/python/tracking-machine-learning/model/lstm/lstm-lite.tflite', 'wb') as f:
    f.write(tflite_model)


  # Load the TFLite model and allocate tensors.
interpreter = tf.lite.Interpreter(model_path="/Users/josecatala/python/tracking-machine-learning/model/lstm/lstm-lite.tflite")
